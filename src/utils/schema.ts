...
export function getBaseBusinessSchema() {
  return {
    ...
    "description": "Emergency plumber, boiler repair, blocked drains, and gas safety services across Bristol and surrounding areas. Gas Safe registered engineers, fast response, 24/7 availability.",
    "url": siteUrl,
...
export function getLocationPageSchema(location: Location) {
  ...
  const locationSchema = {
    ...
    "areaServed": {
      ...
      "containedInPlace": {
        "@type": "AdministrativeArea",
        "name": location.countyOrRegion || "Bristol and surrounding areas"
      }
    },
    "geo": {
      "@type": "GeoCoordinates",
...
export function getLocationServicePageSchema(location: Location, service: Service) {
  ...
  const serviceSchema = {
    ...
    "description": `Professional ${service.name.toLowerCase()} services in ${location.name}, ${location.countyOrRegion || 'Bristol and surrounding areas'}. Gas Safe registered engineers, fast response, 24/7 availability.`,
...
export function getWebSiteSchema() {
  return {
    ...
    "url": siteUrl,
    "name": BRAND.brandName,
    "description": "Emergency plumber, boiler repair, blocked drains, and gas safety services across Bristol and surrounding areas.",
    "publisher": {
      "@id": `${siteUrl}/#organization`
    },
    "inLanguage": "en-GB",
 ...
 * Includes: Organization, WebSite, LocalBusiness
 */
