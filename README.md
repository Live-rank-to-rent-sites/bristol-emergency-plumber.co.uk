...
1. Clone the repository:
   ```bash
   git clone https://github.com/WebFoundryAI/bristolemergencyplumber.co.uk.git
   cd bristolemergencyplumber.co.uk
   ```
...
4. Click **Save**
5. Site will be live at: `https://webfoundryai.github.io/bristolemergencyplumber.co.uk/`
